...
export default function App() {
  ...
  const addNew = (title) => {
    setListe([...liste, { id: liste.length+1, baslik: title, tamamlandi: false }]);//id.date.now() veya liste.length+1 niye??  her yeni eklenen element icin ayri bir seye ihtiyacimiz var, bu hepsi icin farkli olmali, o yüzden burada saat kullanilmis bu farkli birsey de olabilirdi.
